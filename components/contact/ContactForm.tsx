...
const ContactForm = () => {
  return (
    <section className="relative">
      <form className="relative bg-white rounded-xl px-5 py-12 z-20 xl:px-10 xl:py-16 lg:-ml-10 lg:mr-10">
        ...
        <div className="hidden absolute top-10 right-0 bg-custom9 z-10 w-full h-full rounded-xl lg:block"></div>
    </section>
  );
};
