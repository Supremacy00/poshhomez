...
const ExclusiveAgents = () => {
  return (
    <section className="hidden xl:block absolute right-[12%] -bottom-[120px] bg-white rounded-xl shadow-sm w-[270px] p-8 animate-smooth-bounce ">
      <h3 className="text-sm font-normal text-primary-text text-center">
        Our Exclusive Agents
      </h3>
      <div className="mt-3 relative flex items-center mx-auto">
        <div className="w-12 h-12 rounded-full overflow-hidden border-[1.5px] bg-custom1 border-white">
          <Image
        ...
        <div className="w-12 h-12 rounded-full overflow-hidden border-[1.5px] bg-custom1 border-white -ml-2.5">
          <Image
