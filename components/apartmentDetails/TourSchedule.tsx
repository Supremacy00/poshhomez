        ...
        <div className="mt-5 font">
          <div className="w-full">
            <input
              ...
              id="time"
              placeholder="Time"
              className="w-full py-3.5 px-4 placeholder:text-sm placeholder:text-secondary border-[1px] border-custom11 rounded-lg"
            />
          </div>
          ...
          <div className="w-full mt-5">
            <textarea
              ...
              className="w-full h-[150px] px-4 pt-6 placeholder:text-sm placeholder:text-secondary border-[1px] border-custom11 rounded-lg"
            ></textarea>
          </div>
