...
const About = () => {
  return (
    <section className="w-full bg-custom4 text-primary-text pt-24 pb-16 lg:pb-24 lg:pt-[120px]">
      <div className="mx-auto px-4 lg:max-w-[993px] lg:px-5 xl:max-w-[1200px] xxl:px-0">
        ...
        <div className="lg:flex gap-5 mt-8">
          <div className="relative w-full bg-white px-5 py-7 rounded-xl shadow-2xl lg:w-[50%]">
            <h4 className="text-sm text-custom2 font-medium">How It Started</h4>
            ...
            <p className="text-[15px] font-normal text-secondary mt-5 leading-[27px] lg:absolute lg:bottom-5 lg:leading-[30px] ">
